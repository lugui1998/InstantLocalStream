...
use crate::runtime::{AsyncUdpSocket, JoinHandle, Runtime, default_runtime};
    ...
    I: Interceptor,
{
    ...
    shared_udp_socket: Option<Arc<dyn AsyncUdpSocket>>,
    ...
    I: Interceptor + 'static,
{
    ...
    /// Uses an application-owned virtual UDP socket instead of binding a socket
    /// for this peer connection. This is intended for UDP multiplexers that
    /// demultiplex packets into one virtual socket per peer.
    pub fn with_udp_socket(mut self, socket: Arc<dyn AsyncUdpSocket>) -> Self {
        self.shared_udp_socket = Some(socket);
        self
    }
